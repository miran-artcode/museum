...
export const EXHIBIT_SAMPLES = [
  {
    ...
    aiScope: "이미지 생성 및 부분 수정, 화면 편집. 작품 캡션 문안과 작가 노트는 학생이 작성함.",
  ...
  },
  {
    ...
    display: "파편 진열",
    note:
      "우리 동네 목욕탕이 작년에 문을 닫았다. 어릴 때 할머니 손을 잡고 가던 곳이다. 지금은 셔터가 내려가 있고 앞에 부동산 스티커가 붙어 있다.\n그 안에 있던 물건 중에 신발장 열쇠가 생각났다. 들어갈 때 받아서 손목에 차고 있다가 나올 때 돌려주는 물건. 수십 년 동안 매일 수백 명의 손을 거쳤을 텐데, 문을 닫으면 아무도 찾지 않는 물건이 된다.\n번호를 37번으로 정한 이유는 출입구에서 가까운 자리가 먼저 닳는다는 이야기를 목욕탕을 하시던 분께 들었기 때문이다. 그래서 30번대가 가장 닳은 것으로 설정하고, 숫자 획이 얕아져 잘 안 보이도록 했다. 화면에서는 숫자가 결국 읽히지 않는다. 작품 캡션에만 37번이라고 적혀 있다. 관람자가 화면을 믿을지 작품 캡션을 믿을지 잠깐 망설이는 그 자리가 이 작품에서 내가 만들고 싶었던 것이다.",
  },
];
