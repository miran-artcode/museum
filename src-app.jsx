          ...
          {f.src === "obs" ? (
            ...
            <div>
              ...
              {UNIT_MODES.includes(cur.k) && (
                <p className="pc-unit">이 단원의 결과물(실재한 적 없는 유물의 기록 사진과 작품 캡션)은 <b>가림과 우회 · 허구와 파라픽션 · 증거와 포렌식</b> 세 갈래를 겹쳐 쓴 형식입니다. 이 갈래를 골랐다면 단원의 형식과 곧바로 이어집니다.</p>
              )}
              {!UNIT_MODES.includes(cur.k) && (
                <p className="pc-unit">이 단원의 형식은 가림과 우회 · 허구와 파라픽션 · 증거와 포렌식을 겹쳐 놓은 것입니다. 다른 갈래를 골랐다면 아래 「이 단원의 형식으로 어떻게 실현할 것인가」 칸에서 그 방법이 유물 이미지와 작품 캡션 가운데 어느 요소를 맡을지 정해야 합니다.</p>
              )}
            </div>
          )}
        </div>
          ...
          <details>
            ...
            <div style={{ fontSize: 13, lineHeight: 1.8, marginTop: 10 }}>
              ...
              <p style={{ margin: "12px 0 10px" }}>
                ...
                밝히되 다른 갈래를 골라도 된다고 하고, 그 갈래가 유물 이미지와 작품 캡션 가운데 어느 요소를 맡을지 스스로 정하게 하는 편이 판단을 더 요구합니다.
              </p>
              <p style={{ margin: "12px 0 10px" }}>
