        ...
        <div className="card-body">
          <details>
            ...
            <div style={{ fontSize: 13, lineHeight: 1.8, marginTop: 10 }}>
              ...
              <p style={{ margin: "12px 0 10px" }}>
                <b>순회 지도의 순서.</b> ① 목록의 갈래가 모두 같은 학생에게는 다른 갈래의 예를 하나 들어 주고 한 줄만 더 찾게 합니다.
...
function ResearchPanel({ ids, roster, wsMap, gradeMap, surveyMap, sampleMode, openMap }) {
  ...
  const manuscriptMD = () => {
    ...
    L.push("");
    L.push("학생들이 적어 놓은 보이지 않는 것은 1인당 평균 " + say("invis_n", "개") + "였고, 서로 다른 갈래의 수는 평균 " + say("invis_type_n", "갈래") + "였다. 전체 " + tt + "건의 갈래 선택 가운데 가장 많이 고른 방법은 ‘" + topLabel + "’" + josaRo(topLabel) + " " + (tc[topType] || 0) + "건(" + (tt ? Math.round(((tc[topType] || 0) / tt) * 100) : 0) + "%)이었다.");
    L.push("");
