...
const CHANGE_PAIRS = [
  {
    ...
    look: "짝에게 읽힌 뒤 큰 말(노동·시간·기억)이 위치·모양·동작의 말로 바뀌었는지, 자국이 생기는 반복이 문장 안에 들어왔는지 확인함.",
  },
  {
    dim: "미술 개념",
    label: "미술의 정의",
          ...
          <details>
            ...
            <div style={{ fontSize: 13, lineHeight: 1.8, marginTop: 10 }}>
              ...
              <p style={{ margin: "12px 0 10px" }}>
                ...
                그래서 방법 고르기는 발상 단계 앞이 아니라 뒤에 둡니다. 흔적이라는 구체 재료가 생긴 뒤에 자기 작업의 위치를 짚는 사후 위치 짓기입니다.
            ...
            <div style={{ fontSize: 13, lineHeight: 1.8, marginTop: 10 }}>
              ...
              <table className="match-tbl">
                ...
                <tbody>
                  ...
                  <tr><td>사전·사후 텍스트 쌍 CSV</td><td>참여자 × 비교 쌍</td><td>같은 질문에 두 번 답한 곳의 원문을 나란히 인용하는 결과 절.</td></tr>
        ...
        <div className="card-body">
          <details>
            ...
            <p style={{ fontSize: 13, margin: "10px 0" }}>
              창의력의 증진은 완성 이미지 한 점으로 확인하기 어렵습니다. 같은 질문에 두 번 답한 곳, 자기 판단을 세웠다가 뒤집은 곳, 남의 읽기를 받아들이거나 물리친 곳에 생각의 이동이 남습니다. 학습지의 각 항목은 아래 규칙으로 지표와 짝을 이룹니다.
            </p>
            <table className="match-tbl">
              <thead><tr><th style={{ width: 78 }}>차원</th><th>학습지 앞 항목</th><th>학습지 뒤 항목</th><th>대시보드에서 보는 것</th></tr></thead>
              <tbody>
...
const RESEARCH_VARS = [
  ...
  { k: "trace_n", name: "흔적 행 수", unit: "개", def: "단계 6(T6)에서 위치 또는 자국을 채운 행의 수", get: (c) => c.tm.traceN },
...
const DEMO_WS = {
  ...
  "l3.q3": "본 적 없는 배송 기사의 얼굴을 상상해 그리면 내 짐작이 그 사람을 대신한다. 손잡이에 남은 마모라면 짐작 없이도 그 사람의 노동 조건을 전달할 수 있다.",
  ...
  "s3t1.list": [
    ...
    { text: "엘리베이터가 없는 동에서 계단을 오르내리는 일", type: "place" },
  ],
